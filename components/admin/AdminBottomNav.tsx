...
import { Home, ShieldUser, Users } from "lucide-react";

export default function AdminBottomNav({ active }: { active: "home" | "users" | "profile" }) {
  const items = [
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-neutral-800 bg-neutral-950/95 backdrop-blur">
